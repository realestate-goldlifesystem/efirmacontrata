  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload = {
        ...
        "Habitación principal": parseInt(String(formData.roomsCount)) >= 1 ? formData.bedPrincipal : '',
        "Habitación secundaria": parseInt(String(formData.roomsCount)) >= 2 ? formData.bedSecondary : '',
        "Habitación terciaria": parseInt(String(formData.roomsCount)) >= 3 ? formData.bedTertiary : '',
        "Habitación cuaternaria": parseInt(String(formData.roomsCount)) >= 4 ? formData.bedQuaternary : '',
        "Habitación quinaria": parseInt(String(formData.roomsCount)) >= 5 ? formData.bedQuinary : '',
        ...
        "N° o Letra de la Torre": formData.idTypeDescription === 'Torre y número' ? formData.towerLetter : '',
        "N° de inmueble": formData.propertyNumber,
        "N° de Garajes": formData.garagesCount,
        "¿Es Independiente o en Servidumbre?": formData.garagesCount !== 'Ningun' ? formData.garageServitude : '',
        "¿Es Cubierto o descubierto?": formData.garagesCount !== 'Ningun' ? formData.garageCovered : '',
        "N° Asignado del garaje": formData.garagesCount !== 'Ningun' ? formData.garageAssignedNumber : '',
        "¿Dispone de deposito?": formData.hasDeposit,
        "# De Deposito": formData.hasDeposit === 'Depositoㅤ' ? formData.depositNumber : '',
        ...
        "Otro Interno": formData.internalFeatures.includes('Otro') ? formData.otherInternal : '',
        ...
        "Otro Externo": formData.externalFeatures.includes('Otro') ? formData.otherExternal : '',
