  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload = {
        ...
        "¿En que tipo de zona se encuentra el inmueble? [Tipo de zona #1 Zona Residencial]": formData.sectorZoneType === 'Residencial' ? 'Tipo de zona #1 Zona Residencial' : '',
        "¿En que tipo de zona se encuentra el inmueble? [Tipo de zona #2 Zona Comercial]": formData.sectorZoneType === 'Comercial' ? 'Tipo de zona #2 Zona Comercial' : '',
        "¿En que tipo de zona se encuentra el inmueble? [Tipo de zona #3 Zona Industrial]": formData.sectorZoneType === 'Industrial' ? 'Tipo de zona #3 Zona Industrial' : '',
        "¿En que tipo de zona se encuentra el inmueble? [Tipo de zona #4 Zona Campestre]": formData.sectorZoneType === 'Campestre' ? 'Tipo de zona #4 Zona Campestre' : '',
