        ...
        <div className="fixed inset-0 bg-black/70 z-[100] flex items-center justify-center p-4">
          <div className="bg-stone-900 border border-stone-700 w-full max-w-lg rounded-2xl p-6 relative">
            ...
            <ul className="space-y-3 text-sm text-stone-300">
              <li>• <strong>Costos de mejoras:</strong> Documente remodelaciones con facturas para aumentar el valor de adquisición.</li>
              <li>• <strong>Intereses de crédito:</strong> Si el inmueble fue comprado con crédito, los intereses pagados pueden deducirse.</li>
              <li>• <strong>Gastos notariales:</strong> Asegúrese de que los gastos de escrituración sean reportados correctamente.</li>
            </ul>
          </div>
        </div>
      )}
