...
function determinarTipoRegistro(sheet, row, resultadoRPR, datosInmueble) {
  ...
  if (resultadoRPR.esNuevo) {
    Logger.log('📊 TIPO 4: NUEVO PROPIETARIO (RPR recién creado)');
    return {
      tipo: 'TIPO_4',
      descripcion: 'Nuevo propietario - Todo creado desde cero',
      filaOriginal: null,
      regExistenteId: null
    };
  }
  ...
  if (!carpetaNegocioFolder) {
    ...
    return {
      tipo: 'TIPO_1_1',
      descripcion: 'Nuevo inmueble en carpeta de negocio faltante',
      filaOriginal: null,
      regExistenteId: null,
  ...
  if (regExistente) {
    ...
    Logger.log('📊 TIPO 1.2: RENOVACIÓN (mismo inmueble)');
    return {
      tipo: 'TIPO_1_2',
  ...
  if (otrosNegociosResult) {
    ...
    Logger.log('📊 TIPO 1.3: CAMBIO DE TIPO DE NEGOCIO');
    return {
      tipo: 'TIPO_1_3',
  ...
  Logger.log('📊 TIPO 1.1: NUEVO INMUEBLE DEL MISMO PROPIETARIO');
  return {
    tipo: 'TIPO_1_1',
    descripcion: 'Nuevo inmueble - Crear REG completo',
    filaOriginal: null,
    regExistenteId: null,
    carpetaNegocio: carpetaNegocio
  };
